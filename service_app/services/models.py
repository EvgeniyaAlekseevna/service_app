...
class Plan(models.Model):
    ...
    discount_percent = models.PositiveIntegerField(default=0, validators=[MaxValueValidator(99)])
...
class Subscription(models.Model):
    ...
    comment = models.CharField(max_length=255, default='', null=True, db_index=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if creating or self.plan_id != self.__plan_id:
